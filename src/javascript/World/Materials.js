...
export default class Materials {
  ...
  setPures() {
    ...
    this.pures = {};
    this.pures.items = {};
    this.pures.items.red = new THREE.MeshBasicMaterial({ color: 0x1a1a1a });
    ...
    this.pures.items.yellow = new THREE.MeshBasicMaterial({ color: 0xe8e8e8 });
  ...
  setShades() {
    ...
    this.shades = {};
    this.shades.items = {};
    this.shades.indirectColor = "#bfbfbf";
