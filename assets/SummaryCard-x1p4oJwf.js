import{c as n}from"./index-CQEukfXP.js";class a{constructor(){this.content=n,this.storageKey="summaryCardDismissed",this.showDelay=1200,!this.wasDismissedThisSession()&&(this.buildElement(),this.bindEvents(),window.setTimeout(()=>{this.show()},this.showDelay))}wasDismissedThisSession(){try{return window.sessionStorage.getItem(this.storageKey)==="true"}catch{return!1}}markDismissed(){try{window.sessionStorage.setItem(this.storageKey,"true")}catch{}}buildElement(){const{name:e,title:s,bioShort:t,featuredSkills:i}=this.content;this.$element=document.createElement("div"),this.$element.className="sc-card",this.$element.innerHTML=`
...
//# sourceMappingURL=SummaryCard-x1p4oJwf.js.map
