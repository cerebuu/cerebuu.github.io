import{c as r}from"./index-DWcQxTE3.js";import"./debug-vendor-DYGKXP-V.js";import"./three-vendor-BEBCUPdy.js";import"./three-examples-vendor-DV7Fnw5Q.js";import"./motion-vendor-DjKJqAo0.js";import"./physics-vendor-xJPXo_LE.js";import"./audio-vendor-CZjnqYNJ.js";class w{constructor(){this.content=r,this.storageKey="summaryCardDismissed",this.showDelay=1200,!this.wasDismissedThisSession()&&(this.buildElement(),this.bindEvents(),window.setTimeout(()=>{this.show()},this.showDelay))}wasDismissedThisSession(){try{return window.sessionStorage.getItem(this.storageKey)==="true"}catch{return!1}}markDismissed(){try{window.sessionStorage.setItem(this.storageKey,"true")}catch{}}buildElement(){const{name:e,title:s,bioShort:t,featuredSkills:i}=this.content;this.$element=document.createElement("div"),this.$element.className="sc-card",this.$element.innerHTML=`
...
//# sourceMappingURL=SummaryCard-Bfqvy6Ur.js.map
